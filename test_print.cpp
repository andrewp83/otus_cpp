...
BOOST_AUTO_TEST_CASE(test_valid_output)
{
    ...
    BOOST_CHECK_EQUAL(ss.str(), "127.0.0.1");
    
    ss.str("");
    print_ip(long(8875824491850138409), ss);
    BOOST_CHECK_EQUAL(ss.str(), "123.45.67.89.101.112.131.41");
    ...
    ss.str("");
    print_ip(vec, ss);
    BOOST_CHECK_EQUAL(ss.str(), "14.18.123.255");
